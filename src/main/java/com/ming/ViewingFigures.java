...
//		System.setProperty("hadoop.home.dir", "c:/hadoop");
		...
		// Warmup
		JavaPairRDD<Integer, Integer> chapterCountRdd = chapterData.mapToPair(tuple -> new Tuple2<>(tuple._2, 1)).reduceByKey(Integer::sum);
...
//		JavaPairRDD<Integer, Tuple2<Integer, Integer>> joinedRdd = viewData.join(chapterData);
		...
		JavaPairRDD<Integer, Tuple2<Integer, Integer>> joinedRdd = viewData.join(viewData);
...
//		});
		...
		JavaPairRDD<Tuple2<Integer, Integer>, Long> step3 = joinedRdd.mapToPair(row -> new Tuple2<>(new Tuple2<>(row._2._1, row._2._2), 1L));		
